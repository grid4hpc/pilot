# -*- coding: utf-8 -*-
"""
    The following code is werkzeug.serving from Werkzeug 0.8.3
    modified heavily for running with M2Crypto and mandatory
...
class WSGIRequestHandler(BaseHTTPRequestHandler, object):
    ...
    def make_environ(self):
        ...
        environ = {
            ...
            'HTTPS':                '1',
            'x509_client_stack':    self.connection.cert_stack,
            'x509_client_cert':     self.connection.cert_stack[0]
        }
...
def run_simple(hostname, port, application, use_reloader=False,
    ...
    if os.environ.get('WERKZEUG_RUN_MAIN') != 'true':
        ...
        _log('info', ' * Running on https://%s:%d/', display_hostname, port)
    if use_reloader:
