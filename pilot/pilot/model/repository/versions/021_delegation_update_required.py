...
def upgrade():
    tasks_table.c.delegation_update_required.create()
    tasks_table.c.delegation_native_id.create()
...
def downgrade():
    tasks_table.c.delegation_update_required.drop()
    tasks_table.c.delegation_native_id.drop()
